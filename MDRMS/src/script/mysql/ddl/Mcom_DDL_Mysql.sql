...
CREATE TABLE COMTNMOBIDIARYINFO
(
	DIARY_ID              CHAR(20) NOT NULL,
	WORKTIME_REGULAR	  CHAR(1) NULL,
	WORKTIME_EXTENSION	  CHAR(1) NULL,
	WORKTIME_OVERNIGHT	  CHAR(1) NULL,
	SCHDUL_BGNDE          DATETIME NULL,
	SCHDUL_DEPT_ID        VARCHAR(20) NULL,
	SCHDUL_DEPT_NAME      VARCHAR(100) NULL,
	SCHDUL_CHARGER_ID     VARCHAR(20) NULL,
	SCHDUL_CHARGER_NAME   VARCHAR(20) NULL,
	WORK_DETAIL			  VARCHAR(2500) NULL,
	MEMO				  VARCHAR(2500) NULL,
	NUMBER_LINE			  VARCHAR(20) NULL,
	WORKING_PLACE	      VARCHAR(2500) NULL,
	FRST_REGIST_PNTTM     DATETIME NULL,
	FRST_REGISTER_ID      VARCHAR(20) NULL,
	LAST_UPDT_PNTTM       DATETIME NULL,
	LAST_UPDUSR_ID        VARCHAR(20) NULL,
