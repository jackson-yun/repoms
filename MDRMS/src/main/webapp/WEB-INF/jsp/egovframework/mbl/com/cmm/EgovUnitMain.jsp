...
<div data-role="header" data-theme="z" class="com-egovHeaderBar">
	<h1><img src="${pageContext.request.contextPath}/images/egovframework/mbl/bod/logo_new.png" alt="logo"></h1>
</div>
<!-- header end -->
...
<p></p>
<br>
	<a href="${pageContext.request.contextPath}/cop/smt/dsm/EgovDiaryManageList.mdo" rel="external"data-role="button" >일보 333관리</a>
...
<%-- 					<li><a href="${pageContext.request.contextPath}/cop/smt/dsm/EgovDiaryManageList.mdo" rel="external">일보관리</a></li> --%>
...
<div data-role="footer" data-theme="z" class="com-egovFooterBar paddT10" data-position="fixed">
	<h4>Copyright 2018 YOOSHIN<br>Co.Ltd</h4>
</div>
<!-- footer end -->
