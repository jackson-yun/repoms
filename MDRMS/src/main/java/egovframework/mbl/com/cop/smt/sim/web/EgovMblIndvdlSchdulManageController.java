...
public class EgovMblIndvdlSchdulManageController {
    ...
    throws Exception {
        ...
        List<?> indvdlSchdulManageList = egovIndvdlSchdulManageService.selectIndvdlSchdulManageDetail(diaryManageVO);
        // Map -> VO 변환
        BeanUtils.populate(diaryManageVO, (EgovMap) indvdlSchdulManageList.get(0));
        diaryManageVO.setSchdulBgndeYYYMMDD((String)((EgovMap) indvdlSchdulManageList.get(0)).get("schdulBgndeYYYMMDD"));

        model.addAttribute("result", diaryManageVO);
    ...
    throws Exception {
    	...
    	List<?> resultList = egovIndvdlSchdulManageService.selectIndvdlSchdulManageDetail(diaryManageVO);
    	BeanUtils.populate(diaryManageVO, (EgovMap) resultList.get(0));
//    	diaryManageVO.setSchdulBgnde((String)((EgovMap) resultList.get(0)).get("schdulBgnde"));
//
//    	String sSchdulBgnde = diaryManageVO.getSchdulBgnde();
//    	String sSchdulEndde = diaryManageVO.getSchdulEndde();
//
...
//    	indvdlSchdulManageVO.setSchdulEnddeHH(sSchdulEndde.substring(8, 10) + ":" + sSchdulEndde.substring(10, 12));
    	...
    	model.addAttribute("indvdlSchdulManageVO", diaryManageVO);
