...
public class IndvdlSchdulManageDao extends EgovComAbstractDAO {
	...
	/**
	 * 일보데이터 상세조회 한다.
	 * @param indvdlSchdulManageVO - 일보 정보 담김 VO
	 * @return List
	 * @throws Exception
	 */
	public List<?> selectIndvdlSchdulManageDetail(DiaryManageVO diaryManageVO) throws Exception {
		return list("IndvdlSchdulManage.selectIndvdlSchdulManageDetail", diaryManageVO);
	}
